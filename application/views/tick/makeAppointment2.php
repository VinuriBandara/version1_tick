             ...
             <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                  ...
                  <input class="form-control" id="name_property" name="property_name" type="text" placeholder="Name of the property (optional)">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              ...
              <div class="form-group buttons">
                <input type="submit" class="btn btn-primary btn-xl" id="appoint" name="other_appointment" value="Make Appointment">
                <input type="reset" class="btn btn-primary btn-xl">
              </div>
